  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center text-gray-100 ">
        ...
        <div className="relative ">
            ...
            <div className="relative flex flex-col sm:w-[30rem] rounded-lg border-gray-500/50 backdrop-blur-2xl shadow-2xl px-4 border-[1px]">
                    ...
                    <form onSubmit={handleAuthAction} className="mb-4">
                        ...
                        <div className="mb-4">
                            <div className="flex justify-between">
                                ...
                                <div className="cursor-pointer text-indigo-500 no-underline hover:text-indigo-500">
